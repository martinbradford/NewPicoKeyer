...
#define initial_sidetone_freq 558        // "factory default" sidetone frequency setting
#define default_decode 1
...
#define initial_pot_wpm_high_value 25    // Potentiometer WPM fully CW
...
#define dim_backlight_inactive_time 2     // minutes - FEATURE_LCD_BACKLIGHT_AUTO_DIM
...
#define default_sampling_rate 17856
#define default_target_frequency 750
#define default_bucket_count 96
#define default_decoder_magnitude_limit_low 300

#ifdef FEATURE_BUTTONS
  #define analog_buttons_number_of_buttons 5  // includes the command button (command button + 3 memory buttons = 4)
  #define analog_buttons_r1 4.6
  #define analog_buttons_r2 1
//#define MAX_ARRAY_BUTTONS 5
#endif
...
#define PRIMARY_SERIAL_PORT &Serial1
...
#if defined (FEATURE_MABKEYER)
#define SECONDARY_SERIAL_PORT &Serial2
#define SECONDARY_SERIAL_PORT_BAUD 115200

#define TERTIARY_SERIAL_PORT &Serial
#define TERTIARY_SERIAL_PORT_BAUD 115200

#define CLIENT_SERIAL_PORT Serial2

#endif

#define DECODE_PORT Serial1		// the port to use to display decoded CW
...
#define STRAIGHT_KEY_ACTIVE_STATE LOW
  ...
  #define keyer_power_led_awake_duty 90   // PWM duty cycle. 0 is 0%, 255 is 100%
  #define keyer_power_led_asleep_duty 10   // 25 is quite dim. Use 0 for off
#endif
...
#define custom_startup_field "G8FXC Pico Keyer"   // an example could be callsign and name, eg. "AB1XYZ Bob", (or "Worlds best operator" which requires a 20 column display), string length shouldo be no more than the number of columns on the display
